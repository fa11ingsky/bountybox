            ...
            <div style="text-align: center; margin-bottom: 16px;">
                <a @click="payWithStripe()"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28"
                        ...
                        <g>
                            <path fill="#fff"
                                d="M23.5 14.1c0-2.7-2.2-3.7-6.6-4.2-3.2-.4-3.8-.7-3.8-1.5 0-.7.7-1.2 2.3-1.2 2 0 3.2.7 3.5 2.1h4.1c-.2-2.7-2.3-4.4-5.5-4.8V2.5h-3v2.1c-3.2.4-5.1 2.1-5.1 4.4 0 2.7 2.2 3.7 6.6 4.2 3.1.4 3.8.7 3.8 1.5 0 .7-.7 1.2-2.3 1.2-2.1 0-3.5-.7-3.8-2.1H4.5c.2 2.7 2.3 4.4 5.5 4.8v2.1h3v-2.1c3.2-.4 5.1-2.1 5.1-4.4z">
                            </path>
                        </g>
                    </svg>
                    Pay with Stripe
